    ...
    <section id="inicio" className="py-24 sm:py-32 space-y-8">
      <div className="animate-fade-up">
        <span className="badge-available">
          ...
          Diagnóstico operativo gratuito — cupos limitados
        </span>
      </div>
      ...
      <div className="space-y-3 animate-fade-up delay-100">
        ...
        >
          Automatizamos los<br />
          <span className="text-gradient-amber">flujos de datos de su empresa.</span>
        </h1>
      </div>

      <p
        className="text-lg sm:text-xl max-w-2xl leading-relaxed text-[#94a3b8] animate-fade-up delay-200"
        style={{ fontFamily: 'var(--font-inter)', fontWeight: 400 }}
      >
        Liberamos a las Pymes y firmas contables de la transcripción manual de datos. Entregamos información precisa y en tiempo real, operada por Inteligencia Artificial y sin requerir un departamento de TI interno.
      </p>
      ...
      <div className="flex items-center gap-2.5 pt-2 text-sm text-[#64748b] animate-fade-up delay-400">
        <ShieldCheck size={16} className="text-[#f59e0b] flex-shrink-0" aria-hidden="true" />
